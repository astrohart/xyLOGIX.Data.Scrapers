...
namespace xyLOGIX.Data.Scrapers.Interfaces
{
    ...
    public interface IScraperService
    {
        ...
        event ScraperServiceExceptionRaisedEventHandler
        ...
        /// </summary>
        /// <param name="url">
        /// (Required.) String containing the URL of the page to
        /// download and parse.
        /// </param>
        /// <returns>
        ...
        /// extracts the inner-text content of the element at the <paramref name="xpath" />
        /// provided.
        /// </summary>
        /// <param name="url">
        /// (Required.) String containing the URL of the page to
        ...
        /// </param>
        /// <param name="xpath">
        /// (Required.) String containing the XPATH query to use in
        /// order to find the desired element.
        /// </param>
        /// <returns>
        /// String containing the inner textual content of the tag looked up by
        /// the <paramref name="xpath" /> query provided, or blank if the tag was not found
        /// or a problem occurred.
        /// </returns>
        /// <exception cref="T:System.ArgumentException">
        /// Thrown if either of the two
        /// required parameters, <paramref name="url" /> or <paramref name="xpath" />, are
        /// blank.
        /// </exception>
